...
class ProviderCertificationVerified
{
     ...
     */
    public function __construct(ProviderCertification $certification, User $verifiedBy)
    {
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'verified_at' => $this->certification->verified_at,
