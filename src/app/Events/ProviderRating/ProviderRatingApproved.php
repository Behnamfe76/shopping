...
class ProviderRatingApproved
{
     ...
     */
    public function __construct(ProviderRating $rating, int $moderatorId, ?string $notes = null, array $metadata = [])
    {
        $this->rating = $rating;
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'notes' => $this->notes,
            'approved_at' => $this->rating->moderated_at,
    ...
    {
        return 'provider.rating.approved';
    }
