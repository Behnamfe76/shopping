...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return array_merge([
            'main_image' => ['nullable', 'max:15200', 'image'],
            'title' => ['nullable', 'string', 'max:255'],
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('products')->ignore($this->route('product')->id)],
            'description' => ['nullable', 'string', 'max:65535'],
            'category_id' => ['nullable', 'integer', 'exists:categories,id'],
            'brand_id' => ['nullable', 'integer', 'exists:brands,id'],
            'status' => ['nullable', 'integer', Rule::enum(ProductStatus::class)],
            'product_type' => ['nullable', 'integer', Rule::enum(ProductType::class)],
            'has_variant' => ['nullable', 'in:none,one,more_than_one'],
