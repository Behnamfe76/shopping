...
class ProductVariantController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('shopping::product-variants.index', compact('variants'));
    }
    ...
    public function create(): View
    {
        ...
        return view('shopping::product-variants.create');
    }
    ...
    public function store(StoreProductVariantRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('shopping.product-variants.show', $variant)
    ...
    public function show(ProductVariant $variant): View
    {
        ...
        return view('shopping::product-variants.show', compact('variant'));
    }
    ...
    public function edit(ProductVariant $variant): View
    {
        ...
        return view('shopping::product-variants.edit', compact('variant'));
    }
    ...
    public function destroy(ProductVariant $variant): RedirectResponse
    {
        ...
        return redirect()->route('shopping.product-variants.index')
     ...
     */
    public function search(SearchProductVariantRequest $request): View
    {
        ...
        return view('shopping::product-variants.search', compact('variants', 'query'));
    }
    ...
    public function active(): View
    {
        ...
        return view('shopping::product-variants.active', compact('variants'));
    }

    /**
     * Display in-stock product variants.
     */
    public function inStock(): View
    {
        $this->authorize('viewAny', ProductVariant::class);

        $variants = $this->variantService->findInStock();

        return view('shopping::product-variants.in-stock', compact('variants'));
    }
    ...
    public function outOfStock(): View
    {
        ...
        return view('shopping::product-variants.out-of-stock', compact('variants'));
    }
    ...
    public function lowStock(): View
    {
        ...
        return view('shopping::product-variants.low-stock', compact('variants'));
    }
    ...
    public function byProduct(int $productId): View
    {
        ...
        return view('shopping::product-variants.by-product', compact('variants', 'productId'));
    }
     ...
     */
    public function byPriceRange(Request $request): View
    {
        $this->authorize('viewAny', ProductVariant::class);
        ...
        return view('shopping::product-variants.by-price-range', compact('variants', 'minPrice', 'maxPrice'));
    }

    /**
     * Display variants by stock range.
     */
    public function byStockRange(Request $request): View
    {
        $this->authorize('viewAny', ProductVariant::class);
        ...
        return view('shopping::product-variants.by-stock-range', compact('variants', 'minStock', 'maxStock'));
    }

    /**
     * Display variants by weight range.
     */
    public function byWeightRange(Request $request): View
    {
        $this->authorize('viewAny', ProductVariant::class);
        ...
        return view('shopping::product-variants.by-weight-range', compact('variants', 'minWeight', 'maxWeight'));
    }
