...
class CustomerPreferencePermissionSeeder extends Seeder
{
    ...
    private function createRolesAndAssignPermissions(): void
    {
        ...
        $preferenceManagerRole = Role::firstOrCreate(['name' => 'customer-preference-manager', 'guard_name' => 'api']);
        ...
        $customerServiceRole = Role::firstOrCreate(['name' => 'customer-service', 'guard_name' => 'api']);
        ...
        // Analytics role
        $analyticsRole = Role::firstOrCreate(['name' => 'analytics', 'guard_name' => 'api']);
